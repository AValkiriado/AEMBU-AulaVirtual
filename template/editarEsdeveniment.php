...
include 'head.php';
$id = $_GET['id'];
$contingut = mysqli_query($conectar,"select Descripcio from Esdeveniment where id=$id;");
while($cnt=mysqli_fetch_assoc($contingut)){
  $contingut = $cnt['Contingut'];
}
?>
<head>
	<meta charset="UTF-8">
	<title>AEMBU Aula Virtual</title>
  ...
  <style type="text/css">
    ...
    #toolBar1 select { font-size:10pt; }
    #textBox {
      width: 80%;
      height: 70%;
...
<div class="wrapper a">
        <?php
            ...
            include 'aside.php';
        ?>
<form name="compForm" method="post" action="../php/guardarEsdeveniment.php" onsubmit="if(validateMode()){this.myDoc.value=oDoc.innerHTML;return true;}return false;" style="margin: 2%;">
<input type="hidden" name="myDoc">
<input type="hidden" name="id" value="<?php echo $id;?>">
<div id="toolBar1">
<select onchange="formatDoc('formatblock',this[this.selectedIndex].value);this.selectedIndex=0;">
<option selected>- Tipus de Text -</option>
<option value="h1">Titol 1 &lt;h1&gt;</option>
<option value="h2">Titol 2 &lt;h2&gt;</option>
<option value="h3">Titol 3 &lt;h3&gt;</option>
<option value="h4">Titol 4 &lt;h4&gt;</option>
<option value="h5">Titol 5 &lt;h5&gt;</option>
<option value="h6">Subtítol &lt;h6&gt;</option>
<option value="p">Paràgraf &lt;p&gt;</option>
<option value="pre">Formatejat &lt;pre&gt;</option>
</select>
...
<option class="heading" selected>- Tamany -</option>
<option value="1">Super Petit</option>
<option value="2">Una mica petit</option>
<option value="3">Normal</option>
<option value="4">Mitjà</option>
<option value="5">Gran</option>
<option value="6">Molt gran</option>
...
<option class="heading" selected>- Color de Fons -</option>
<option value="red">Roig</option>
<option value="green">Verd</option>
<option value="black">Negre</option>
</select>
...
<img class="intLink" title="Hyperlink" onclick="var sLnk=prompt('Escriu aquí la ruta','http:\/\/');if(sLnk&&sLnk!=''&&sLnk!='http://'){formatDoc('createlink',sLnk)}" src="data:image/gif;base64,R0lGODlhFgAWAOMKAB1ChDRLY19vj3mOrpGjuaezxrCztb/I19Ha7Pv8/f///////////////////////yH5BAEKAA8ALAAAAAAWABYAAARY8MlJq7046827/2BYIQVhHg9pEgVGIklyDEUBy/RlE4FQF4dCj2AQXAiJQDCWQCAEBwIioEMQBgSAFhDAGghGi9XgHAhMNoSZgJkJei33UESv2+/4vD4TAQA7" />
